...
export default function define(runtime, observer) {
  ...
  const fileAttachments = new Map([
    ["land-110m.json", {url: new URL("./files/low.json", import.meta.url), mimeType: "application/json", toString}],
    ["land-50m.json", {url: new URL("./files/high.json", import.meta.url), mimeType: "application/json", toString}]
  ]);
